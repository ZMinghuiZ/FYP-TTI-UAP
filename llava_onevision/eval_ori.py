...
# grayscale_to_rgb was added in torchvision >= 0.19; older builds need this polyfill.
try:
...
def main(model_path, accident_folder):
    ...
    csv_filename = f"llava_onevision_results_{timestamp}.csv"
    ...
    with open(csv_filename, mode='w', newline='', encoding='utf-8-sig') as csv_file:
        ...
        for filename in tqdm(files):
            ...
            try:
                ...
                # 2. Process inputs (num_frames=32 to align with UAP's N=32)
    ...
    with open("llava_onevision_summary_metrics.txt", "w") as f:
